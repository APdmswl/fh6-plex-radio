...
//
//   GET  /api/source/plex/libraries
//   GET  /api/source/plex/playlists
//   GET  /api/source/plex/artists
//   GET  /api/source/plex/albums
//   GET  /api/source/plex/queue
//   POST /api/source/plex/refresh
//
