...
Config load_config(const std::filesystem::path& path) {
    ...
    cfg.general.open_dashboard_on_start =
        pick<bool>(g, "open_dashboard_on_start", cfg.general.open_dashboard_on_start);
    ...
    cfg.plex.library_key  = pick<std::string>(px, "library_key", cfg.plex.library_key);
    cfg.plex.playlist_key = pick<std::string>(px, "playlist_key", cfg.plex.playlist_key);
    cfg.plex.artist_key   = pick<std::string>(px, "artist_key", cfg.plex.artist_key);
    cfg.plex.album_key    = pick<std::string>(px, "album_key", cfg.plex.album_key);
    cfg.plex.ffmpeg_path  = pick_path(px, "ffmpeg_path");
...
void save_config(const std::filesystem::path& path, const Config& cfg) {
    ...
    e.kv("library_key", cfg.plex.library_key);
    e.kv("playlist_key", cfg.plex.playlist_key);
    e.kv("artist_key", cfg.plex.artist_key);
    e.kv("album_key", cfg.plex.album_key);
    e.kv_path("ffmpeg_path", cfg.plex.ffmpeg_path);
